...
switch(pg_id){
	case 1:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><img id="asset1" src="slide1/1.png" width="1080" height="810">';
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen" /><img id="asset1" src="slide2/1.png" width="1080" height="810"><img id="asset2" src="slide2/2.png"><img id="asset3" src="slide2/3.png" ><audio id="yesaudio" playsinline><source src="slide2/yes.mp3"></source></audio><audio id="noaudio" playsinline><source src="slide2/no.mp3"></source></audio><audio id="ding" playsinline><source src="slide2/success.mp3"></source></audio>';
	break;
}
